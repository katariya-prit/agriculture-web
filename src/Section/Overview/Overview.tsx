...
export default function Overview() {
    return (
        <div className="relative min-h-screen bg-white text-slate-800 overflow-x-hidden font-sans w-full">
            ...
            <header className="fixed top-0 z-50 backdrop-blur-md shadow-lg bg-white/80 border-b border-emerald-500/10 w-full">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        {[
                            "About Us", "Services"].map((label) => (
                                <Button
                                    Icon={<FiBook />}
                                    classname={`h-10 w-20 text-sm rounded-lg sm:w-30 sm:text-base`}
                                    type={undefined}
                                    disabled={false}
                                    name={`${label}`}
                                />
